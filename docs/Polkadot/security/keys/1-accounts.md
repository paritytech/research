...
Supporting BLS12-381 signatures enables true aggregation.  These could also be integrateed with how session keys appear on-chain, though no compelling argument currently justifies doing so.
